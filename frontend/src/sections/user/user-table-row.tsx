...
type UserTableRowProps = {
  ...
  selected: boolean;
  onSelectRow: () => void;
  onDeleteUser: (user: UserProps) => void;  // 부모에서 전달된 삭제 함수
  onEditUser: (user: UserProps) => void;  // 부모에서 전달된 삭제 함수
};

export function UserTableRow({ row, selected, onSelectRow, onDeleteUser, onEditUser}: UserTableRowProps) {
